import { middlewareLoggedIn, registerCommand, runCommand, CommandsRegistry } from './registry';
...
import { handlerFollow, handlerListFeedFollows, handlerUnfollow } from './handler_follow';
